Action()
{
	...
	web_custom_request("v3", 
		"URL=https://a.nel.cloudflare.com/report/v3?s=AnTKuE8rVjdHjuk8AGflaOgLsk6J9LBPSCIJKj3a5XniImQcR7XbWMkcyy1SNbPFYmKnBN05RlEnra5oBgunA3ICPiVhLUFMVHST0gxg5tbbi8%2BBYtyYmjlR6alTJjWoFRGbjpWi", 
		"Method=OPTIONS", 
		"Resource=0", 
		"Referer=", 
		"Snapshot=t4.inf", 
